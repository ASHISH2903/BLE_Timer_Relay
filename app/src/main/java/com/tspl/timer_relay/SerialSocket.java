    ...
    public void onServicesDiscovered(BluetoothGatt gatt, int status) {
        ...
        for (BluetoothGattService gattService : gatt.getServices()) {
            ...
            if (gattService.getUuid().equals(UUID.fromString("0783b03e-8535-b5a0-7140-a304d2495cb7"))) {
                ...
                //for(BluetoothGattCharacteristic characteristic : gattService.getCharacteristics())
                //    Log.d(TAG, "characteristic "+characteristic.getUuid());
                readCharacteristic = gattService.getCharacteristic( UUID.fromString( "0783b03e-8535-b5a0-7140-a304d2495cb8" ) );
                writeCharacteristic = gattService.getCharacteristic( UUID.fromString( "0783b03e-8535-b5a0-7140-a304d2495cba" ) );
            }
        }
